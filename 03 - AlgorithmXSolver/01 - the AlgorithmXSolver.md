...
__All detailed examples in this playground are coded in Python, but don’t forget to check the [translations page](overview) if you prefer another coding language!__
